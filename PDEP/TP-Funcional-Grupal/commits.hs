...
branchInfinito :: Branch -> Branch
branchInfinito branch = branchInfinito (UnBranch (commit1 : (listaCommits branch)))
--Agrega de manera infinita commit1 al branch que se le pase